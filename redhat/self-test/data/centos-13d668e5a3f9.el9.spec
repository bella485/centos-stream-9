...
%global distro_build 78.test.el9
...
Source0: linux-5.14.0-78.test.el9.tar.xz
...
%setup -q -n kernel-5.14.0-78.test.el9 -c
mv linux-5.14.0-78.test.el9 linux-%{KVERREL}
